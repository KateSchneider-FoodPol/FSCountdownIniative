...
map_2018 <- mapCountryData(mapworld, nameColumnToPlot="X2018.2022",mapTitle = "Total renewable water resources from 2018 to 2022", colourPalette = c("#cc5803","#e2711d","#ff9505","#ffb700","#ffc300","#48cae4","#00b4d8","#0096c7","#0077b6","#023e8a"),oceanCol = "light blue",missingCountryCol = 'gray',addLegend = FALSE)
...
par(mai=c(0,0,0.2,0),xaxs="i",yaxs="i")
map_2013 <- mapCountryData(mapworld, nameColumnToPlot="X2013.2017",mapTitle = "Total renewable water resources from 2013 to 2017", colourPalette = c("#cc5803","#e2711d","#ff9505","#ffb700","#ffc300","#48cae4","#00b4d8","#0096c7","#0077b6","#023e8a"),oceanCol = "light blue",missingCountryCol = 'gray',addLegend = FALSE)
