...
WorldMap_SPCover <- joinCountryData2Map(spcoverage, joinCode = "NAME", nameJoinColumn = "country_name")
par(mai=c(0,0,0.2,0),xaxs="i",yaxs="i")
mapCountryData(WorldMap_SPCover, nameColumnToPlot = "2019", mapTitle = "Social Protection Coverage, 2019", colourPalette = c("#e0f3db","#ccebc5","#a8ddb5","#7bccc4","#4eb3d3","#2b8cbe","#0868ac","#084081"), oceanCol = "gray", missingCountryCol = 'white') 
